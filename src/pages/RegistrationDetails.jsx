...
function RegistrationDetails({ NavigateToNext }) {
    ...
    const draweOpenStatus = NavigateToNext.draweOpenStatus;
                    ...
                    <Grid columns={12} container>
                            ...
                            <Paper variant="elevation" sx={{ m: 1 }}>
                                ...
                                <Grid columns={12} container >
                                    <Controls.Select
                                        ...
                                        draweOpenStatus={draweOpenStatus}
                                    />
                                    <Controls.Input
                                        label="First Name"
                                        onChange={handleChange}
                            ...
                            <Paper variant="elevation" sx={{ m: 1 }}>
                                ...
                                <Grid columns={12} container>
                                    ...
                                    <Grid item xs={12} sm={6} md={6} lg={4}>
                                        <LoadingButton startIcon={<SearchIcon />} sx={{ m: 1, width: draweOpenStatus ? '30ch' : '40ch' }} variant="contained"
                        ...
                        <Grid columns={12} container sx={{ display: 'block' }}>
                            ...
                            <Paper elevation={1} sx={{ m: 1 }}>
                                <Grid columns={12} container>
                                    <LoadingButton startIcon={<SendIcon />} sx={{ m: 1, width: draweOpenStatus ? '30ch' : '40ch' }} variant="contained"
